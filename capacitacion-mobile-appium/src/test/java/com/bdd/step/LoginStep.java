...
public class LoginStep {
    ...
    private static LoginView loginSauceView() {
    ...
    @Step
    public static void validarAlerta(String mensajeEsperado) {
        Assert.assertTrue("No mostro mensaje: " + mensajeEsperado, loginSauceView().validarAlerta(mensajeEsperado));
