...
public class LoginGlue {
    ...
    public void noIngresoUsernameNiPassword() {
      Util.logger(this.getClass()).log(Level.WARNING,"No se ingreso User y Pass");
    }

    @Entonces("me muestra el mensaje {string}")
    public void meMuestraElMensaje(String mensajeEsperado) {
        LoginStep.validarAlerta(mensajeEsperado);
    }
