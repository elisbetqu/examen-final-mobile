...
public class MobileDriverManager {
    ...
    public static void setMobileDriver() {
        ...
        desiredCapabilities.setCapability("app", "/Elisbet/Bootcamp/Clase Mobile/capacitacion-mobile-appium/src/test/resources/app/Android-MyDemoSaucelabs.apk");
...
//        appiumHub = "https://hub-cloud.browserstack.com/wd/hub";
    ...
    public static void quitDriver() {
         if (driver != null) {
             ...
             MobileDriverManager.getDriver().terminateApp("com.saucelabs.mydemoapp.rn");
